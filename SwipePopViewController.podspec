...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwipePopViewController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/chalermpong/SwipePopViewController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'chalermpong' => 's_pong_c@hotmail.com' }
  s.source           = { :git => 'https://github.com/chalermpong/SwipePopViewController.git', :tag => s.version.to_s }
